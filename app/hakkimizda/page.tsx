        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <section className="py-20 px-4">
                <div className="max-w-7xl mx-auto text-center animate-fade-in-up">
                    <PageTitle title="Hakkımızda" subtitle="Green Palace Games'in hikayesini ve değerlerini keşfedin" />
                </div>
            </section>
                    ...
                    <div className="bg-white rounded-xl shadow-lg p-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 mb-2">Tutku</h4>
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 mb-2">İnovasyon</h4>
                                    <p className="text-gray-600 text-sm">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 mb-2">Kalite</h4>
                                    <p className="text-gray-600 text-sm">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div>
                                    <h4 className="font-bold text-gray-900 mb-2">Kullanıcı Odaklılık</h4>
                                    <p className="text-gray-600 text-sm">
