...
export default async function GameDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Hero Section */}
      <section className="relative h-96 bg-gradient-to-br from-purple-500 to-blue-600 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center text-center px-4">
          <div>
            <div className="mb-4">
              <span className={`${statusColors[game.status]} text-white text-sm font-semibold px-4 py-2 rounded-full`}>
